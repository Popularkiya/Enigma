...
int Mechanism::FindIndexOf_AlphabetOriginal_UsingRelativePos(int index_of_permutation) {
	int amount_of_transitions = this->relative_permutation[index_of_permutation].relative_position_sub_to_alph;
...
int Mechanism::FindIndexOf_Substitute_UsingRelativePos(int index_of_permutation) {
	int amount_of_transitions = this->relative_permutation[index_of_permutation].relative_position_alph_to_sub;
